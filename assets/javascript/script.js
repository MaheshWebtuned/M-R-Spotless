...
$(document).ready(function () {
  $(".formDropDown").on("click", function (e) {
    ...
    $(".formDropDown-ul-list")
      .not($(this).next(".position-relative").find(".formDropDown-ul-list"))
      .slideUp(280);
    $(".arrow-icon-form")
      .not($(this).find(".arrow-icon-form"))
      .removeClass("up");

    // Toggle current dropdown
    $(this)
      .next(".position-relative")
      .find(".formDropDown-ul-list")
      .slideToggle(280);
...
/*--------------------------- Accordian Section from FAQ page ------------------------*/
